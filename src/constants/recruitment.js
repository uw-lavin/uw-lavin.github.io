...
export const RECRUITMENT_TABS_DATA = [
    {
        label: "LAVIN STUDENTS",
        // Note: Icons are React components, so we can't fully serialize this if we wanted to be pure JSON.
        // For a constants file in JS/JSX, this is fine.
        iconType: 'graduate',
        content: (
